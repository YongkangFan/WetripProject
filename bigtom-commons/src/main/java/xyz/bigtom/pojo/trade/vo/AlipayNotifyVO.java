...
/**
 * <b>汤姆旅游租赁平台-支付管理-支付宝支付异步通知视图信息</b>
 * @author fanyongkang
 * @version 1.0.0
 * @since 1.0.0
 */
@ApiModel("汤姆旅游租赁平台-支付管理-支付宝支付异步通知视图信息")
public class AlipayNotifyVO extends BaseVO {
	private static final long serialVersionUID = -4029230134370397625L;
	@ApiModelProperty(value = "通知时间")
	private Date notify_time;
	@ApiModelProperty(value = "通知类型")
	private String notify_type;
	@ApiModelProperty(value = "通知效验ID")
	...
	@ApiModelProperty(value = "开发者app_id")
