...
public class PageVO<E> implements Serializable {
	private static final long serialVersionUID = 7102759600334604790L;
	...
	private static Properties props = new Properties();            //Proper对象

	static{
		try{
			//通过使用静态代码块加载Properties配置文件
